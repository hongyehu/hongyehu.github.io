...
<section class="home-section home-section-feature">
  <h2>个人简介</h2>
  <p>我将于7月作为<span class="home-theme-text">特聘研究员 (Associate Professor)</span>加入<span class="home-theme-text">中科院物理所</span>，课题组获得<strong>国家级海外青年人才项目</strong>与<strong>中科院百人项目</strong>支持。计划每年招收<strong>博士生 1-2 人，长期招收博士后、访问学生与访问学者</strong>。课题组将与<strong>中科院物理所</strong>、<strong>清华大学</strong>、<strong>北京大学</strong>进行深度合作，理论结合实验，发展中性原子、超导、NV量子色心等平台的新型量子算法与应用。欢迎各位有志之士加入、共建量子+AI的未来。</p>
  ...
  <ol class="home-numbered-list">
    ...
    <li><span class="home-theme-text">Ansatz-free 哈密顿量学习技术</span>：首次提出对任意哈密顿量感知学习并可达到海森堡测量极限算法，被美国物理协会 APS 选作 <a href="https://physics.aps.org/articles/v18/165" target="_blank" rel="noopener noreferrer">Viewpoint 报道</a>。</li>
